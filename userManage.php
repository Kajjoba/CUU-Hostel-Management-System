      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
              <div class="form-group">
                  ...
                  <input class="form-control" id="registration" name="registration" placeholder="Choose a unique Username" type="text" required value="CUU-00000<?php echo $user_id; ?>" >
              </div>
              <div class="form-row">
                    ...
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon">+256</span>
                            </div>
