<div class="container-fluid" style="margin-top:98px">
	<div class="col-lg-12">
		...
		<div class="card">
            ...
            <span style="font-weight: bold; color: red; font-size: 30px;">Hostel Students</span>
            </div>
			<div class="card-body">
				<table class="table-striped table-bordered col-md-12 text-center">
                    <thead style="background-color: rgb(111 202 203);">
                        <tr>
                        <th style="font-weight: bold; color: red; font-size: 18px;">Registration No.</th>
                        <th style="font-weight: bold; color: red; font-size: 18px;">Student's Name</th>
                        <th style="font-weight: bold; color: red; font-size: 18px;">Room No.</th>
                        <th style="font-weight: bold; color: red; font-size: 18px;">Seater</th>
                        <th style="font-weight: bold; color: red; font-size: 18px;">Staying From</th>
                        <th style="font-weight: bold; color: red; font-size: 18px;">Contact No.</th>
                        <th style="font-weight: bold; color: red; font-size: 18px;">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
