            ...
            <div class="col-md-12">
                <form action="partials/_hostelManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <span style="font-weight: bold; color: red; font-size: 30px;">Hostel Booking</span>
                        </div>
                        <div class="card-body">
                        <div class="row">
                    ...
                    <?php } ?>
                        ...
                        <option value="1">Required (Extra 500000 shillings. per Semester)</option>
                        ...
                        <br>
                        <center>
                         <p style="font-weight: bold; color: red; font-size: 18px;">Student's Personal Information</p>
                        </center>
                        <div class="row">
                            <div class="form-group col-md-4">
                    ...
                    <?php } ?>
                        ...
                        <center>
                          <p style="font-weight: bold; color: red; font-size: 18px;">Guardian's Information</p>
                        </center>
                        <div class="row">
                            <div class="form-group col-md-4">
                            ...
                            <br>
                            <center>
                              <p style="font-weight: bold; color: red; font-size: 18px;">Address Information</p>
                            </center>
