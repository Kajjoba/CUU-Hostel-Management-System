<div class="container-fluid" style="margin-top:98px">
    ...
    <span style="font-weight: bold; color: red; font-size: 30px;">Manage Rooms</span>
                         </div>
			<div class="card-body">
				<table class="table-striped table-bordered col-md-12 text-center">
                    <thead style="background-color: rgb(111 202 203);">
                        <tr>
                        <th style="font-weight: bold; color: red; font-size: 20px;">Room No.</th>
                        <th style="font-weight: bold; color: red; font-size: 20px;">Seater</th>
                        <th style="font-weight: bold; color: red; font-size: 20px;">Fees per Month</th>
                        <th style="font-weight: bold; color: red; font-size: 20px;">Action</th>      
                        </tr>
                    </thead>
                    <tbody>
                        <?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h4 class="modal-title" id="newroom">Add New Room</h4>
