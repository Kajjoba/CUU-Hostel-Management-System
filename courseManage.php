<div class="container-fluid" style="margin-top:98px">
	...
	<div class="col-lg-12">
        ...
        <div class="card">
            ...
            <span style="font-weight: bold; color: red; font-size: 30px;">Manage Courses</span>
            </div>
			...
			<div class="card-body">
				<table class="table-striped table-bordered col-md-12 text-center">
                    <thead style="background-color: rgb(111 202 203);">
                        <tr>
                        <th style="font-weight: bold; color: red; font-size: 16px;">Course Code</th>
                        <th style="font-weight: bold; color: red; font-size: 16px;">Course</th>
                        <th style="font-weight: bold; color: red; font-size: 16px;">Course Full Name</th>
                        <th style="font-weight: bold; color: red; font-size: 16px;">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
